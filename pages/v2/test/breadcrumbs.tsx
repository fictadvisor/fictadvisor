            ...
            <div className={breadcrumbStyles["breadcrumb-wrap"]}>
                <div className={breadcrumbStyles["icon-home-breadcrumb"]}>
                    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            stroke="#d4d4d4" stroke-width="3.1111" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
                ...
                <div className={breadcrumbStyles["chevron-right-breadcrumb"]}>
                    <svg viewBox="0 0 16 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2.672 3.203l10.656 12.797-10.656 12.797" stroke="#d4d4d4" stroke-width="3.112"
                ...
                <div className={breadcrumbStyles["chevron-right-breadcrumb"]}>
                    <svg viewBox="0 0 16 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2.672 3.203l10.656 12.797-10.656 12.797" stroke="#d4d4d4" stroke-width="2.4"
                              stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
