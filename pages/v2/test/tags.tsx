  ...
  return (
    <div className={styles["test-page-wrap"]}>
      <div className={styles["test-page-content"]}>
        ...
        ></Tag>
        <Tag
          className="success-second"
          text="success"
          state={TagState.SMALL}
          icon={<CustomCheck />}
        ></Tag>
        <Tag
          className="success-third"
          text="success"
          state={TagState.BIG}
          icon={<CustomCheck />}
        ></Tag>
        ...
        ></Tag>
        <Tag
          className="warning-second"
          text="warning"
          state={TagState.SMALL}
          icon={<CustomCheck />}
        ></Tag>
        <Tag
          className="warning-third"
          text="warning"
          state={TagState.BIG}
          icon={<CustomCheck />}
        ></Tag>
        ...
        ></Tag>
        <Tag
          className="info-second"
          text="info"
          state={TagState.SMALL}
          icon={<CustomCheck />}
        ></Tag>
        <Tag
          className="info-third"
          text="info"
          state={TagState.BIG}
          icon={<CustomCheck />}
        ></Tag>
        ...
        <Tag
          className="gray-first"
          text="gray"
          state={TagState.SMALL}
          icon={<CustomCheck />}
        ></Tag>
        <Tag
          className="gray-second"
          text="gray"
          state={TagState.SMALL}
          icon={<CustomCheck />}
        ></Tag>
        <Tag
          className="gray-third"
          text="gray"
          state={TagState.BIG}
          icon={<CustomCheck />}
        ></Tag>
        ...
        ></Tag>
        <Tag
          className="violet-second"
          text="gray"
          state={TagState.SMALL}
          icon={<CustomCheck />}
        ></Tag>
        <Tag
          className="violet-third"
          text="gray"
          state={TagState.BIG}
          icon={<CustomCheck />}
        ></Tag>
        ...
        ></Tag>
        <Tag
          className="mint-second"
          text="gray"
          state={TagState.SMALL}
          icon={<CustomCheck />}
        ></Tag>
        <Tag
          className="mint-third"
          text="gray"
          state={TagState.BIG}
          icon={<CustomCheck />}
        ></Tag>
        ...
        ></Tag>
        <Tag
          className="orange-second"
          text="gray"
          state={TagState.SMALL}
          icon={<CustomCheck />}
        ></Tag>
        <Tag
          className="orange-third"
          text="gray"
          state={TagState.BIG}
          icon={<CustomCheck />}
        ></Tag>
