...
import * as styles from '@/components/pages/account-page/components/group-tab/components/table/student-table/components/editing-column/EditingColumn.styles';
import { StudentsTableItem } from '@/components/pages/account-page/components/group-tab/components/table/types';
