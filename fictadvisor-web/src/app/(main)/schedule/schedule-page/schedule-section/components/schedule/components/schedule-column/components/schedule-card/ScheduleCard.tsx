...
import { calculateScheduleLineTop } from '@/app/(main)/schedule/schedule-page/schedule-section/components/schedule/components/schedule-column/components/schedule-card/utils/calculateScheduleLineTop';
import ScheduleLine from '@/app/(main)/schedule/schedule-page/schedule-section/components/schedule/components/schedule-line';
