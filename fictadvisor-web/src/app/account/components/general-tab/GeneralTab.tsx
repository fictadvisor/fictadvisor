...
import ChangeAvatarWindow from '@/app/account/components/general-tab/components/change-avatar-window';
import ContactsBlock from '@/app/account/components/general-tab/components/contacts-block/ContactsBlock';
import PersonalInfoBlock from '@/app/account/components/general-tab/components/personal-info';
import * as stylesMui from '@/app/account/components/general-tab/GeneralTab.styles';
