...
import ContactForm from '@/app/account/components/general-tab/components/contacts-block/components/ContactForm';
import ContactItem from '@/app/account/components/general-tab/components/contacts-block/components/ContactItem';
import { Contact } from '@/app/account/components/general-tab/components/contacts-block/types';
