...
import {
  initialValues,
  validationSchema,
} from '@/app/account/components/general-tab/components/contacts-block/validation';
import * as styles from '@/app/account/components/general-tab/GeneralTab.styles';
