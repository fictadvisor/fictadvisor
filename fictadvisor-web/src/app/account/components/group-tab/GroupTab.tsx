...
import NoGroupBlock from '@/app/account/components/group-tab/components/no-group-block';
import RequestsTable from '@/app/account/components/group-tab/components/table/requests-table';
import StudentsTable from '@/app/account/components/group-tab/components/table/student-table';
import {
  transformRequestsData,
  transformStudentsData,
} from '@/app/account/components/group-tab/components/table/utils';
