...
import roleNamesMapper from '@/app/account/components/group-tab/components/table/constants';
import * as gridStyles from '@/app/account/components/group-tab/components/table/grid.styles';
import TransferCaptainPopup from '@/app/account/components/group-tab/components/table/student-table/components/editing-column/TransferCaptainPopup';
import MobileDropdown from '@/app/account/components/group-tab/components/table/student-table/components/mobile-dropdown/MobileDropdown';
...
import { PERMISSION } from '../../../../../../../../../../../utils/src/security/PERMISSION';
