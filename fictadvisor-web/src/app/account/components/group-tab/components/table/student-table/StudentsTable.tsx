...
import EditingColumn from '@/app/account/components/group-tab/components/table/student-table/components/editing-column/EditingColumn';
import { TextAreaPopup } from '@/app/account/components/group-tab/components/text-area-popup';
