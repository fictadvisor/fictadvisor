...
import { getPriorityName } from '@/app/(admission)/_priority-approve/utils/getPriorityName';
import { getSpecialityName } from '@/app/(admission)/_priority-approve/utils/getSpecialityName';
