...
import {
  initialValues,
  SPECIALITIES,
} from 'src/app/(admission)/_contract-admin/constants';
import { validationSchema } from 'src/app/(admission)/_contract-admin/validation';

import * as styles from '@/app/(admission)/_contract-admin/ContractAdminPage.styles';
