...
import {
  ...
  IPeduPrograms,
  ISTeduPrograms,
} from '@/app/(admission)/(main)/_priority-approve/components/priority-page/constants';
import * as styles from '@/app/(admission)/(main)/_priority-approve/components/priority-page/PriorityPage.styles';
import {
  getLocalStorage,
  saveLocalStorage,
} from '@/app/(admission)/(main)/_priority-approve/components/priority-page/utils/localStorage';
import {
  optionalValidationSchema,
  validationSchema,
} from '@/app/(admission)/(main)/_priority-approve/components/priority-page/validation';
