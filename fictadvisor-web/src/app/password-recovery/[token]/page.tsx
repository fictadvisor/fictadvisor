...
import CreatePasswordForm from '@/app/password-recovery/[token]/components/create-password-form';
import * as styles from '@/app/password-recovery/[token]/CreatePasswordPage.styles';
