...
import PersonalSubjectTeacherTabs from 'src/app/discipline/personal-subject-teacher-tabs';

import styles from '@/app/discipline/PersonalTeacherSubjectPage.module.scss';
...
const PersonalTeacherSubject = () => {
  ...
  const teacherId = query.get('teacherId') as string;
