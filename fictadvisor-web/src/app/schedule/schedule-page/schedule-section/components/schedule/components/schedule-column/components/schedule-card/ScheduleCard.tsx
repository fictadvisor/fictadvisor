...
import { calculateScheduleLineTop } from '@/app/schedule/schedule-page/schedule-section/components/schedule/components/schedule-column/components/schedule-card/utils/calculateScheduleLineTop';
import ScheduleLine from '@/app/schedule/schedule-page/schedule-section/components/schedule/components/schedule-line';
import { ScheduleLineVariant } from '@/app/schedule/schedule-page/schedule-section/components/schedule/components/schedule-line/types';
import { getStringTime } from '@/app/schedule/schedule-page/utils/getStringTime';
