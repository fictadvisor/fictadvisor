...
import { GroupsDropDown } from '@/app/schedule/schedule-page/calendar-section/components/groups-dropdown/GroupsDropDown';
import { CheckboxesDropdown } from '@/app/schedule/schedule-page/calendar-section/components/mobile/checkboxes-dropdown/CheckboxesDropDown';
