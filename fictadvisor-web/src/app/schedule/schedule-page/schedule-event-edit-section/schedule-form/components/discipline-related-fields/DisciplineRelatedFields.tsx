...
import { AddDeleteTeachers } from '@/app/schedule/schedule-page/schedule-event-edit-section/schedule-form/components/add-delete-teachers/AddDeleteTeachers';
import { ScheduleFormikDropdown } from '@/app/schedule/schedule-page/schedule-event-edit-section/schedule-form/components/schedule-dropdown/ScheduleDropdown';
import { skeletonProps } from '@/app/schedule/schedule-page/schedule-event-edit-section/utils/skeletonProps';
