...
import { TeachersPageTabs } from '@/app/(search-pages)/teachers/[teacherId]/utils';
...
const CommentTab = dynamic(
  () =>
    import(
      '@/app/(search-pages)/teachers/[teacherId]/personal-teacher-tabs/components/comment-tab'
    ),
);
const GeneralTab = dynamic(
  () =>
    import(
      '@/app/(search-pages)/teachers/[teacherId]/personal-teacher-tabs/components/general-tab'
    ),
);
const PollButtons = dynamic(
  () =>
    import(
      '@/app/(search-pages)/teachers/[teacherId]/personal-teacher-tabs/components/poll-buttons'
    ),
);
const SubjectTab = dynamic(
  () =>
    import(
      '@/app/(search-pages)/teachers/[teacherId]/personal-teacher-tabs/components/subject-tab'
    ),
);
