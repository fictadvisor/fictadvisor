...
import { PollTeacherInitialValues } from '@/app/(search-pages)/poll/components/poll-search-form/constants';
import { PollSearchFormFields } from '@/app/(search-pages)/poll/components/poll-search-form/types';
import PollTeacherSearchList from '@/app/(search-pages)/poll/components/poll-teacher-search-list/PollTeacherSearchList';
import * as styles from '@/app/(search-pages)/poll/PollTeacherPage.styles';
