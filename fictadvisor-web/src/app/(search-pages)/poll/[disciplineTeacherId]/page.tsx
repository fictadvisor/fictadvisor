...
import PollForm from '@/app/(search-pages)/poll/[disciplineTeacherId]/components/poll-form';
import * as styles from '@/app/(search-pages)/poll/[disciplineTeacherId]/PollPage.styles';
