...
import { SubjectSearchList } from '@/app/(search-pages)/subjects/components/SubjectSearchList';
import {
  breadcrumbs,
  filterOptions,
  PAGE_SIZE,
} from '@/app/(search-pages)/subjects/constants';
import * as styles from '@/app/(search-pages)/subjects/SubjectSearchPage.styles';
