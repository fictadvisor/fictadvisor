...
export class SitemapService {
    ...
    public async build() {
        ...
        const teachers = await this.teacherRepository.find({ where: {}, select: ['link', 'updatedAt'] });
        const subjects = await this.subjectRepository.find({ where: {}, select: ['link', 'updatedAt'] });
