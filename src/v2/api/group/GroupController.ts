...
export class GroupController {
  ...
  async create (@Body() body: CreateGroupDTO) {
    return await this.groupService.create(body.code);
  }
  ...
  @Param('groupId', GroupByIdPipe) groupId: string,
    ...
    await this.groupService.updateGroup(groupId, body);
  }
  ...
  @Param('groupId', GroupByIdPipe) groupId: string
    ...
    return await this.groupService.getStudents(groupId);
  }
  ...
  @Param('groupId', GroupByIdPipe) groupId: string
    ...
    return await this.groupService.getCaptain(groupId);
  }
  ...
  @Param('groupId', GroupByIdPipe) groupId: string
    ...
    return await this.groupService.getDisciplineTeachers(groupId);
  }
  ...
  @Param('groupId', GroupByIdPipe) groupId: string,
    ...
    await this.groupService.verifyStudent(groupId, userId, body);
  }
  ...
  @Param('groupId', GroupByIdPipe) groupId: string,
    ...
    await this.groupService.moderatorSwitch(groupId, userId, body);
  }
  ...
  @Param('groupId', GroupByIdPipe) groupId: string,
    ...
    await this.groupService.removeStudent(groupId, userId);
  }
}
