...
import NumberedTextArea from '@/components/pages/account-page/components/group-tab/components/numbered-text-area';
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.description}>
          ...
          адреси через Enter або кому. Також скопіювавши весь радок електроних
