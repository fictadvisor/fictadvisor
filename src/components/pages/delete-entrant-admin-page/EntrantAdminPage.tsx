...
import {
  ...
  initialValues,
} from '@/components/pages/delete-entrant-admin-page/constants';
import {
  getLocalStorage,
  saveLocalStorage,
} from '@/components/pages/delete-entrant-admin-page/utils/localStorage';
import { validationSchema } from '@/components/pages/delete-entrant-admin-page/validation';
