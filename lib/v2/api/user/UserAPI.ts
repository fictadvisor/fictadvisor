...
export class UserAPI {
    ...
    static async createRoleUserBody(accessToken: string, userId: string, body: CreateRoleUserBody){
    ...
    static async deleteRole(accessToken: string, body: DeleteRoleUserBody, userId: string, roleId: string) {
