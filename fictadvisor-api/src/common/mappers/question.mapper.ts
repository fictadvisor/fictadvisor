...
import { DbDisciplineTeacherWithAnswers } from '../../database/v2/entities/discipline-teacher-with-answers.entity';
import { DbQuestionWithAnswers } from '../../database/v2/entities/question-with-answers.entity';
import { QuestionCommentData } from '../../modules/poll/v2/types/question-comment.data';
