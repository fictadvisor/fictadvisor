...
import { ComplaintDTO, QueryAllTeacherDTO, ResponseQueryDTO, UpdateContactDTO } from '@fictadvisor/utils/requests';
...
import { Prisma, QuestionDisplay, Cathedra, TeachersOnCathedras } from '@prisma/client';
