...
import { every, everyAsync, filterAsync, find, some } from '../../../common/helpers/array.util';
import { UserService } from '../../user/v2/user.service';
import { DbEvent } from '../../../database/v2/entities/event.entity';
import { DbDiscipline, DbDiscipline_DisciplineTeacher } from '../../../database/v2/entities/discipline.entity';
...
import { GeneralParser } from '../../parser/general-parser';
