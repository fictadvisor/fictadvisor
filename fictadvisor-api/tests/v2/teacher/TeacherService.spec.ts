...
import { TeacherModule } from '../../../src/modules/teacher/TeacherModule';
import { PollModule } from '../../../src/modules/poll/PollModule';
...
import { CreateContactData } from './datas/CreateContactData';
import { GroupRepository } from '../../../src/database/v2/repositories/GroupRepository';
...
describe('TeacherService', () => {
  ...
  describe('getAll', () => {
    ...
    it('should return all teachers', async () => {
      ...
      const searchParam: QueryAllTeacherDTO =
    ...
    it('should return specified teacher by cathedra', async () => {
      ...
      const searchParam: QueryAllTeacherDTO = { cathedrasId: [teacher2.cathedras[0].cathedraId] };
    ...
    it('should return specified teacher by name', async () => {
      ...
      const searchParam: QueryAllTeacherDTO = { search: teacherFullName };
